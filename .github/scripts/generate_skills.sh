...
# The skill name is automatically generated as "alloydb-omni-<toolset>"
SKILLS=(
  "data"
...
RAW_URL="https://raw.githubusercontent.com/googleapis/mcp-toolbox/v${VERSION}/internal/prebuiltconfigs/tools/alloydb-omni.yaml"
...
generate_skill() {
  local TOOLSET="$1"
  local SKILL_DESC="$2"
  local SKILL_NAME="alloydb-omni-$TOOLSET"

  echo "Generating skill: $SKILL_NAME..."

  npx "@toolbox-sdk/server@${VERSION}" --prebuilt alloydb-omni skills-generate \
    --name "$SKILL_NAME" \
